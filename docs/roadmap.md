...
| Pinyin-aware heading search | Optionally match Chinese workspace headings by Pinyin full spelling or initials without persistent indexing. Addresses [#132](https://github.com/realDestroyer/org-vscode/issues/132). | DONE (Unreleased) | Next bundled release | realDestroyer |
