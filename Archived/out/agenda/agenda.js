...
function readAgendaFiles(dateFormat) {
    const agendaEntries = {};
    ...
    return Object.fromEntries(Object.entries(agendaEntries).sort(([a], [b]) => moment(a, dateFormat).toDate().getTime() - moment(b, dateFormat).toDate().getTime()));
}
...
function createWebview(agendaData) {
...
function getWebviewContent(agendaEntries) {
