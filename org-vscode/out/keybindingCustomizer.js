...
function getKeybindingModel() {
  ...
  const summaryByCommand = new Map([
    ...
    ["extension.toggleStatusRight", "Rotate the task keyword forward (TODO → IN_PROGRESS → CONTINUED → DONE → ABANDONED)."],
    ["extension.toggleStatusLeft", "Rotate the task keyword backward (ABANDONED → DONE → CONTINUED → IN_PROGRESS → TODO)."],
